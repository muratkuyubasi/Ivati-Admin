using CenazeFonu.API.Helpers;
using CenazeFonu.API.Helpers.Mapping;
using CenazeFonu.Data;
using CenazeFonu.Data.Dto;
using CenazeFonu.Domain;
using CenazeFonu.Helper;
using CenazeFonu.MediatR.PipeLineBehavior;
...
namespace CenazeFonu.API
{
    public class Startup
    {
        ...
        {
            var assembly = AppDomain.CurrentDomain.Load("CenazeFonu.MediatR");
            ...
            services.AddDbContextPool<PTContext>(options =>
            {
                options.UseSqlServer(Configuration.GetConnectionString("PTConnectionString"))
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory, IWebHostEnvironment env)
        {
            ...
            //RecurringJob.AddOrUpdate<RecurringJobs>("18 Ya�", x => x.OnSekizYasaGirenler(), "* 12 * * *");
            //RecurringJob.AddOrUpdate<RecurringJobs>("Fatura G�nder", x => x.FaturaGonder(), "0 00 1 1 1");
            //backgroundJobClient.Enqueue(() => Console.WriteLine("AAA"));
            //            app.UseHangfireDashboard("/swedencronjob", new DashboardOptions
            //            {
            //                DashboardTitle = "�sve� - Cronjob",
            //                Authorization = new[]
            //{
            //            new HangfireCustomBasicAuthenticationFilter{
            //                User = "SwedenCron",
            //                Pass = "Vakif@Global2023"
            //            }
            //            }
            //            });
            app.UseSwagger(c =>
