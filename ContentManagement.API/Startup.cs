...
using ContentManagement.MediatR.PipeLineBehavior;
using ContentManagement.Data;
using ContentManagement.API.Helpers.Mapping;
...
namespace ContentManagement.API
{
    public class Startup
    {
        ...
        {
            var assembly = AppDomain.CurrentDomain.Load("ContentManagement.MediatR");
