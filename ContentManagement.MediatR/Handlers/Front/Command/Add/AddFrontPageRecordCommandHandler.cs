...
{
    public class AddFrontPageRecordCommandHandler : IRequestHandler<AddFrontPageRecordCommand, ServiceResponse<FrontPageRecordDto>>
    {
        private readonly IFrontPageRecordRepository _FrontPageRecordRepository;
        private readonly IUnitOfWork<PTContext> _uow;
        private readonly IMapper _mapper;
        private readonly ILogger<AddFrontPageRecordCommandHandler> _logger;
        public AddFrontPageRecordCommandHandler(
           IFrontPageRecordRepository FrontPageRecordRepository,
            IMapper mapper,
            IUnitOfWork<PTContext> uow,
            ILogger<AddFrontPageRecordCommandHandler> logger
            )
        {
        ...
        public async Task<ServiceResponse<FrontPageRecordDto>> Handle(AddFrontPageRecordCommand request, CancellationToken cancellationToken)
        {
            var entity = _mapper.Map<Data.FrontPageRecord>(request);
            entity.Code = Guid.NewGuid();
            _FrontPageRecordRepository.Add(entity);
