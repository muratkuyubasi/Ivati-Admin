...
{
    public class UserRepository : GenericRepository<User, PTContext>,
          IUserRepository
    {
        ...
        public async Task<UserAuthDto> BuildUserAuthObject(User appUser)
        {
            ...
            ret.ModifiedDate = appUser.ModifiedDate;
        ...
        //        if (user != null)
        //        {
        //            if (!HashingHelper.VerifyPasswordHash(password, user.PasswordHash, user.SecurityStamp))
        //            {
        ...
        //        }
        //        return new ErrorDataResult<User>(Messages.KullanıcıBulunamadı);
        //    }
        //}
    }
}
